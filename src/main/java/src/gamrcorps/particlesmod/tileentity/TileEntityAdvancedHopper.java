 ...
 */
public class TileEntityAdvancedHopper extends TileEntityHopper {
    ...
    {
        return this.hasCustomName() ? this.customName : "container.distributionHopper";
    }
    ...
    public boolean insertHook(TileEntityHopper hopper)
    {
        return insertHook(hopper, BlockHopper.getFacing(hopper.getBlockMetadata()));
    }

    public boolean insertHook(IHopper hopper, EnumFacing facing)
    {
